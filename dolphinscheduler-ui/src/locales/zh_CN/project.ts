...
export default {
  ...
  node: {
    ...
    paste_from_clipboard: '从剪切板粘贴',
    copy_to_clipboard_warning: '没有选择要复制到剪切板的任务',
    copy_to_clipboard_success: '个任务复制到剪切板了',
    paste_from_clipboard_warning: '没有任务要粘贴',
    delete: '删除',
    custom_job: '自定义任务',
    custom_script: '自定义脚本',
    sqoop_job_name: '任务名称',
