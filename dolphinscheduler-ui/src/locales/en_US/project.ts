...
export default {
  ...
  node: {
    ...
    edit: 'Edit',
    copy: 'Copy',
    copy_to_clipboard: 'To clipboard',
    paste_from_clipboard: 'From clipboard',
    copy_to_clipboard_warning: 'No task selected for copying to clipboard',
    copy_to_clipboard_success: ' tasks copied to the clipboard',
    paste_from_clipboard_warning: 'No task to paste',
    delete: 'Delete',
